...
- **Search** — live ranked (semantic + keyword) search over your local Nimbus index; results update as you type and open their source on select. **Search Selection** seeds it from the editor.
